class Dm2ControllerGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      m.template('index.html.erb', File.join('app/views', class_path, file_name, "index.html.erb")) if actions.include?("index") or actions.blank?
      begin
      ...
      m.template('edit.html.erb', File.join('app/views', class_path, file_name, "edit.html.erb")) if actions.include?("edit")  or actions.blank?
      m.template('new.html.erb', File.join('app/views', class_path, file_name, "new.html.erb")) if actions.include?("new") or actions.blank?
